...
export const racesCollectibles: Collectible[] = [
{
    ...
    type: "Human",
    icon: "assets/icons/races/race-highland-human.webp",
    cost: 10_000,
    rarity: "Common",
    requirements: [],
  },
{
    ...
    type: "Elf",
    icon: "assets/icons/races/race-moon-elf.webp",
    cost: 24_000,
    rarity: "Uncommon",
  ...
  },
{
    ...
    type: "Dwarf",
    icon: "assets/icons/races/race-ironhold-dwarf.webp",
    cost: 24_000,
    rarity: "Uncommon",
  ...
  },
{
    ...
    type: "Orc",
    icon: "assets/icons/races/race-ashen-orc.webp",
    cost: 34_000,
    rarity: "Rare",
  ...
  },
{
    ...
    type: "Goblin",
    icon: "assets/icons/races/race-mire-goblin.webp",
    cost: 18_000,
    rarity: "Common",
  ...
  },
{
    ...
    type: "Troll",
    icon: "assets/icons/races/race-stoneback-troll.webp",
    cost: 70_000,
    rarity: "Epic",
    requirements: [
  ...
  },
{
    ...
    type: "Machine",
    icon: "assets/icons/races/race-brassbound.webp",
    cost: 88_000,
    rarity: "Epic",
    requirements: [
  ...
  },
{
    ...
    type: "Undead",
    icon: "assets/icons/races/race-duskborne.webp",
    cost: 120_000,
    rarity: "Legendary",
    requirements: [
